...
#define RUN_TEST( fn ) \
 ...
 void setup() {
  ...
  delay( 2000 );
  Serial.println( " " );
  Serial.print("Compiler Version: "); Serial.print(__VERSION__); Serial.print("  C++ Version: "); Serial.println(__cplusplus);
  Serial.print("Optimization level: "); Serial.println(__OPTIMIZE__);
  Serial.println( "Optimise -O2 " );
}

void loop() {
  
  //RUN_TEST( 0 );  // To time the scaffolding of the test. 
